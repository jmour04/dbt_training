...
final as (
    ...
    select
        ...
        nvl(order_amounts_by_custmer.total_revenue_in_usd, 0) 
    ...
    left join order_amounts_by_custmer
        on customers.customer_id = order_amounts_by_custmer.customer_id
)
